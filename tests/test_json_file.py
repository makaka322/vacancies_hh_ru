...
def test_json_file_init(json_file):
    ...
    assert json_file.file_name == r"C:\Users\Тёма\PycharmProjects\vacancies_hh_ru\date\vacancies.json"
...
def test_write_file(vacan_list):
    ...
    file = JsonFile("C:Users/Тёма/PycharmProjects/vacancies_hh_ru/tests/test_vacancies.json")
    file.write_file(vacan_list)
    with open(r"C:\Users\Тёма\PycharmProjects\vacancies_hh_ru\date\vacancies.json",
